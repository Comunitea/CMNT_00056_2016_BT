    ...
    def compute_refund(self, mode="refund"):
        ...
        if created_inv and created_inv[0]:
            ...
            inv_obj.browse(refund_inv_id).write(
                {
                    "payment_mode_id": orig_invoice.payment_mode_id
                    and orig_invoice.payment_mode_id.id
                    or False,
                    "partner_bank_id": orig_invoice.partner_bank_id
                    and orig_invoice.partner_bank_id.id
                    or False,
                }
            )
