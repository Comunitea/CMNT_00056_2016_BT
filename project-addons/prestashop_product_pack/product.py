    ...
    def _after_import(self, erp_id):
        ...
        for variant in erp_id.product_variant_ids:
            ...
            for pack_line in erp_id.imported_pack_line_ids:
                pack_variant = (
                    pack_line.product_id.product_variant_ids
                    and pack_line.product_id.product_variant_ids[0]
                )
                if not pack_variant:
                    continue
