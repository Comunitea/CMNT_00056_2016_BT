            ...
            if not partner:
                ...
                if procurement.rule_id.group_propagation_option == 'propagate':
                    available_draft_po_ids = po_obj.search(cr, uid, [
                        ...
                        ('location_id', '=', procurement.location_id.id), ('company_id', '=', procurement.company_id.id), ('dest_address_id', '=', procurement.partner_dest_id.id), ('procurement_group_id', '=', procurement.group_id.id)], context=context)
                else:
                    available_draft_po_ids = po_obj.search(cr, uid, [
                        ('partner_id', '=', partner.id), ('state', '=', 'draft'), ('picking_type_id', '=', procurement.rule_id.picking_type_id.id),
                        ('location_id', '=', procurement.location_id.id), ('company_id', '=', procurement.company_id.id), ('dest_address_id', '=', procurement.partner_dest_id.id), ('procurement_group_id', '=', False)], context=context)
