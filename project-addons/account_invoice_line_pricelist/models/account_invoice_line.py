    ...
    def product_id_change(
        ...
        if currency_id:
            ...
            if (
                ...
                pricelist = (
                    self._context.get("pricelist_id", False)
                    or (
                ...
                if pricelist:
                    ...
                    if (
                        "uos_id" in res["value"]
                        and res["value"]["uos_id"]
                        and res["value"]["uos_id"] != product_data.uom_id.id
                    ):
                        pricedict = pricelist.with_context(
                            uom=res["value"]["uos_id"]
                        ).price_get(product, qty, partner_id)
                    else:
